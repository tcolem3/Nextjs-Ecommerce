...
const ProductForm = ({type, product, productId} : {
    ...
    // const form3 = useForm<z.infer z.infer<typeOf insertProductSchema>>({
    //     resolver: type === 'Update' ? zodResolver(updateProductSchema) : zodResolver(insertProductSchema),
    //     defaultValues: product && type === 'Update' ? product : productDefaultValues
    // });

    // const form2 = useForm<z.infer<typeof insertProductSchema>>({
    //     resolver: type === 'Update' ? zodResolver(updateProductSchema) : zodResolver(insertProductSchema),
    //     defaultValues: product && type === 'Update' ? product : productDefaultValues
    //   });
    ...
    return ( 
        <Form {...form}>
            <form method='POST' onSubmit={form.handleSubmit(onSubmit)} className='space-y-8'>
                <div className="flex flex-col-gap5 md:flex-row">
                    {/* {Name} */}
                    <FormField
                ...
                <div className="upload-field flex flex-col-gap5 md:flex-row">
                    {/* {Images} */}
                    <FormField
                    control={form.control}
                    name='images'
                    ...
                    <Card>
                        ...
                        { isFeatured && banner && (
                            <Image src={banner} alt='banner image'
                                className='w-full object-cover object-center rounded-sm' width={1920} height={680}
                            />
                        )}
